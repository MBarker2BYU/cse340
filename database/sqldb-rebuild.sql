...
-- This script inserts sample data into the inventory table for a vehicle inventory system.
...
-- This updates the description of the Hummer in the inventory table
UPDATE 
inventory
SET 
...
-- This updates the image and thumbnail paths in the inventory table to include a specific directory for vehicles
UPDATE 
    inventory
SET 
